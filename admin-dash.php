                    ...
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                      <thead>
                        ...
                        <tr>
                          ...
                          <th scope="col" class="px-0 text-muted">Checkin</th>
                          <th scope="col" class="px-0 text-muted">Checkout</th>
                          <th scope="col" class="px-0 text-muted">Guest</th>
                          <th scope="col" class="px-0 text-muted">Room</th>
                         <th scope="col" class="px-0 text-muted">Suite</th>
                          <th scope="col" class="px-0 text-muted">Request</th>
                      </thead>
                      <tbody>
                         <?php $srno = 1;
